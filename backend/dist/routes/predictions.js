...
const cycleModel_1 = require("../models/cycleModel");
const storage_1 = require("../data/storage");
exports.predictionsRouter = (0, express_1.Router)();
// POST /api/predict
exports.predictionsRouter.post('/predict', async (req, res) => {
    try {
        ...
        const prediction = await (0, cycleModel_1.makePrediction)({
...
// GET /api/predictions
exports.predictionsRouter.get('/predictions', (req, res) => {
    try {
        const predictions = (0, storage_1.getPredictions)();
        res.json({
            success: true,
